...
def eval_base():
    ...
    logging.basicConfig(filename="./log/rpl_1_utility_base.log",
            filemode='a',
    ...
    for level in level_list:
        ...
        for corruption in for_list:
            ...
            acc_base = test_base_rpl(teloader_2, base_model)
...
def eval_online():
    ...
    logging.basicConfig(filename="./log/rpl_1_utility_online.log",
            filemode='a',
            format='%(asctime)s, %(name)s %(levelname)s %(message)s',
            datefmt='%Y-%m-%d  %H:%M:%S',
            level=logging.DEBUG)
    ...
    for num_warmup in [40]:
        ...
        for corruption in cr_list:
            ...
            for i in range(3):
                ...
                acc_online = test_online_rpl(teloader_2, model)
